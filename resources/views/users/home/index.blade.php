      ...
      <form id="formPembayaran" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" name="rekening_id" required>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    bayarBtns.forEach(btn => {
        btn.addEventListener('click', function () {
            ...
            formPembayaran.action = `/user/pembayaran/${id}/upload-bukti`;
        });
    });
    ...
    let form = e.target;
    let id = form.dataset.id; // ambil id dari data-id

    let formData = new FormData(form);

    fetch(`/user/pembayaran/${id}/upload-bukti`, {
        method: 'POST',
        headers: {
    ...
    .catch(err => console.error(err));
            ...
            .then(data => {
                ...
                submitBtn.innerHTML = 'Upload Bukti';
                ...
                if (data.success) {
                    ...
                    alert(data.message || 'Terjadi kesalahan saat mengirim bukti pembayaran');
                }
            })
            .catch(error => {
